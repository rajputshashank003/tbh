...
const Page2 = () => {
  return (
    <div data-scroll data-scroll-speed={0.01} className="bg-white min-h-[100vh] md:top-[60px] relative rounded-[12px] shadow-[0px_0px_10px] shadow-gray-200">
        <div data-scroll data-scroll-speed={0.06} className="relative top-[-100px] ">
            ...
            <div className="clg_names mx-[2%] sm:mx-[5%] md:mx-[20%]  rounded-[20px] max-sm:gap-[0px]  bg-white min-h-[150px] shadow-md flex flex-row max-sm:flex-row justify-around items-center shadow-gray-400 bg">
