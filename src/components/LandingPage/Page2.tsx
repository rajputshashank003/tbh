...
const Page2 = () => {
  return (
    <div data-scroll data-scroll-speed={0.01} className="bg-white max-sm:mx-[8vw] min-h-[100vh] md:top-[60px] relative flex flex-col justify-center items-center rounded-[12px] shadow-[0px_0px_10px] shadow-gray-200">
