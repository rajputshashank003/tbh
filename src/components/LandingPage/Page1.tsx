    ...
    return (
        <div className="lg:grid grid-cols-2 items-center flex flex-col md:px-[100px] px-[20px] py-[26px] text-[#211E1D] overflow-hidden ">
            ...
            <div ref={arrows} className="flex flex-col col-span-1 max-md:min-h-[60vh] min-h-[100vh] max-lg:w-[350px] top-10 lg:-top-10 left-0 relative">
                <img src="/star2.svg" alt="" className="absolute a1 z-[3] w-[4vw] left-[50%] top-[50%]" />
                <img src="/o.svg" alt="" className="absolute a2 z-[3] w-[4vw] left-[80%] top-[40%]" />
                <img src="/star1.svg" alt="" className="absolute a3 z-[3] w-[4vw] left-[14%] top-[40%]" />
