...
const Page6 = () => {
    ...
    return (
        <div data-scroll data-scroll-speed={0.06} ref={par} className="rounded-[12px] max-sm:mx-[4%] bg-white shadow-[0px_2px_16px] shadow-gray-300 mt-[40px] py-[16px] px-[16px] min-h-[70vh] ">
