const Page3 = () => {
    return (
        <div data-scroll data-scroll-speed={0.09} className="md:grid max-sm:mx-[8vw] md:grid-cols-2 md:gap-[26px] py-[5%] px-[2%] bg-white mt-[20px] rounded-[12px] shadow-[0px_0px_10px] shadow-gray-200 overflow-hidden flex flex-col lg:mx-[15%] md:mx-[8%] mx-[2%] ">
